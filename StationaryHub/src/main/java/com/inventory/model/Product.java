...
public class Product implements Comparable<Product>{
	...
	public Product(int product_id, String product_name, double product_price, int product_quantity,
			String product_category, Blob image,Date created_at) {
		super();
	...
	public Product(int product_id, String product_name, double product_price, Blob img,
			Date created_at) {
		super();
		this.product_id = product_id;
		this.product_name = product_name;
	...
	public Product( String product_name, double product_price, Blob img) {
		super();
//		this.product_id = product_id;
		this.product_name = product_name;
		this.product_price = product_price;
