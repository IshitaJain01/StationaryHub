							...
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide swiper-slide1">
									<div class="product-desc">
										<a class="icon cursor" href="auth/Login.html"> <i
											class="fa-solid fa-heart"></i>
										</a>
										<h1>Kurta</h1>
										<h5>Diaddl Color: Black, Case Shape: Round, Dial Glass
											Material: Mineral</h5>
										...
										<a
											href="product/singleproduct0818.html?id=62cc7ac1caf52635f99f4e6e">
											<button class="cursor">
									...
									<div class="product-img cursor">
										<img
											src="images/uploads/1657567924011yourchoice4504369700095896women3.jpg"
											alt="" />
									</div>
								</div>
								...
								<div class="swiper-slide swiper-slide1">
									<div class="product-desc">
										...
										<a
											href="product/singleproduct0deb.html?id=62cbde36e76dfba6233d9b3c">
											<button class="cursor">
												view <i class="fa-solid fa-expand"></i>
											</button>
										</a>
									...
									<div class="product-img cursor">
										<img
											src="images/uploads/1657527858415yourchoice8826970721994936sunglasspng4.jpg"
											alt="" />
									</div>
								</div>
								...
								<div class="swiper-slide swiper-slide1">
									<div class="product-desc">
										...
										<h1>Tshirt</h1>
										<h5>, is a style of fabric shirt named after the T shape
											of its body and sleeves. Traditionally, it has short sleeves
											and a round neckline</h5>
										...
										<a
											href="product/singleproduct2785.html?id=62cc6079245ede6f099cfa68">
											<button class="cursor">
												view <i class="fa-solid fa-expand"></i>
											</button>
										</a>
									...
									<div class="product-img cursor">
										<img
											src="images/uploads/1657561202963yourchoice9229602196134266tshirt4.webp"
											alt="" />
									</div>
								</div>
			...
			<div class="swiper mySwiper3">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide swiper-slide3 product-card">
						...
						<div class="product">
							<div class="product-background"
								style="background: rgb(243, 172, 128);">
								<div class="product-background-circle"></div>
							</div>
							<div class="product-image">
								<img
									src="images/uploads/1657567924010yourchoice3052189983817770womenpng.jpg"
									alt="" />
							</div>
						</div>
						<div class="product-info">
							...
							<h4>$1255</h4>
							<a
								href="product/singleproduct0818.html?id=62cc7ac1caf52635f99f4e6e"><button>
									view <i class="fa-solid fa-expand"></i>
								</button></a>
						</div>
					</div>
					...
					<div class="swiper-slide swiper-slide3 product-card">
						...
						<div class="product">
							<div class="product-background"
								style="background: rgb(58, 176, 98);">
								<div class="product-background-circle"></div>
							</div>
							<div class="product-image">
								<img
									src="images/uploads/1657561202962yourchoice4744228777935655tshirt1.jpg"
									alt="" />
							</div>
						</div>
						<div class="product-info">
							...
							<h4>$399</h4>
							<a
								href="product/singleproduct2785.html?id=62cc6079245ede6f099cfa68"><button>
									view <i class="fa-solid fa-expand"></i>
								</button></a>
						</div>
					</div>
					...
					<div class="swiper-slide swiper-slide3 product-card">
						...
						<div class="product">
							<div class="product-background"
								style="background: rgb(138, 145, 244);">
								<div class="product-background-circle"></div>
							</div>
							<div class="product-image">
								<img
									src="images/uploads/1657527858413yourchoice6314888914517969sunglasspng.jpg"
									alt="" />
							</div>
						</div>
						<div class="product-info">
							...
							<h4>$200</h4>
							<a
								href="product/singleproduct0deb.html?id=62cbde36e76dfba6233d9b3c"><button>
									view <i class="fa-solid fa-expand"></i>
								</button></a>
						</div>
					</div>
